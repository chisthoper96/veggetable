...
De por si el hummus encima lleva perejil y aliño, otras veces se pueden variar con aceitunas, guisantes, etcétera. Teniendo la receta tradicional ya puedes jugar a combinar esta rica preparación como desees.', types_of_food: 'vegano' rating: 3, image_url: ''})
...
# recipes16 = Recipe.create({name_recipes: '', preparation: '', types_of_food: '', rating: , image_url: ''})
