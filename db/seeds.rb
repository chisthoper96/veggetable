...
ingredients57 = Ingredient.new({name_ingredient: 'judías'})
...
recetaingrediente14 = IngredientRecipe.create({recipe: recipes4, ingredient: ingredients6 })
recetaingrediente1000 = IngredientRecipe.create({recipe: recipes4, ingredient: ingredients19 })
recetaingrediente1001 = IngredientRecipe.create({recipe: recipes4, ingredient: ingredients27 })
recetaingrediente1002 = IngredientRecipe.create({recipe: recipes4, ingredient: ingredients8 })
...
Ahora para finalizar añada la mayor parte del pesto a la sopa y a continuación repártala en los platos. Corone cada uno de eenllos con un poco de pesto reservado y sirva la sopa caliente.', types_of_food: 'vegano', rating: 3, image_url: 'https://www.vegrecetas.com/wp-content/uploads/sopa-pesto-vegan.jpg'})
recipes10.save!
